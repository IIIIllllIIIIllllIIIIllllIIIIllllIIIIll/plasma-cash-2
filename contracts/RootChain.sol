...
contract RootChain {
    ...
    function checkInclusion(
        uint256 coinId,
        IncludedTransfer memory itxn,
        bytes memory txnProof
    ...
    function startExit(
        ...
        IncludedTransfer memory c,
        bytes memory cProof,

        IncludedTransfer memory pc,
        bytes memory pcProof
    )
        public
    {
    ...
    function spends(
        IncludedTransfer memory a,
        IncludedTransfer memory b,
        uint256 deadline
    ...
    function challengeExit(
        ...
        IncludedTransfer memory cs,
        bytes memory csProof
    ) public {
    ...
    function respondChallengeExit(
        ...
        address exitBeneficiary,
        uint256 csBlkNum,
        IncludedTransfer memory css,
        bytes memory cssProof
    )
        public
    {
    ...
    function finalizeExit(uint256 coinId, address payable exitBeneficiary) public {
        Exit storage exit = exits[coinId][exitBeneficiary];
